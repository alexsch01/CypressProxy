...
exports.CookiesHelper = exports.getSameSiteContext = exports.addCookieJarCookiesToRequest = exports.calculateSiteContext = exports.shouldAttachAndSetCookies = void 0;
const tslib_1 = require("tslib");
const lodash_1 = tslib_1.__importDefault(require("lodash"));
const url_1 = require("url");
const network_1 = require(process.argv[1]+"/../packages/network");
const cors_1 = require(process.argv[1]+"/../packages/network/lib/cors");
 ...
 * @returns {boolean}
 */
const shouldAttachAndSetCookies = (requestUrl, AUTUrl, resourceType, credentialLevel, isAutFrame) => {
    if (!AUTUrl)
        return false;
    const siteContext = (0, exports.calculateSiteContext)(requestUrl, AUTUrl);
    switch (resourceType) {
        case 'fetch':
...
exports.shouldAttachAndSetCookies = shouldAttachAndSetCookies;
/**
 ...
 */
const calculateSiteContext = (url1, url2) => {
    if ((0, cors_1.urlOriginsMatch)(url1, url2)) {
        return 'same-origin';
    }
    if ((0, cors_1.urlSameSiteMatch)(url1, url2)) {
        return 'same-site';
    }
    return 'cross-site';
};
exports.calculateSiteContext = calculateSiteContext;
...
const getSameSiteContext = (autUrl, requestUrl, isAUTFrameRequest) => {
    ...
    if (!autUrl || network_1.cors.urlSameSiteMatch(autUrl, requestUrl)) {
        return 'strict';
    }
...
class CookiesHelper {
    constructor({ cookieJar, currentAUTUrl, request, debug }) {
        ...
        this.siteContext = (0, exports.calculateSiteContext)(this.request.url, this.currentAUTUrl || '');
    ...
    capturePreviousCookies() {
        ...
        // is a noop
        if (!this.request.doesTopNeedSimulating)
            return;
    ...
    setCookie(cookie) {
        ...
        const shouldSetCookieGivenSiteContext = (0, exports.shouldAttachAndSetCookies)(this.request.url, this.currentAUTUrl, this.request.resourceType, this.request.credentialLevel, this.request.isAUTFrame);
