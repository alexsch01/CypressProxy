...
class QueueMap {
    ...
    removeExact(queueKey, value) {
        var _a;
        const i = (_a = this.queues[queueKey]) === null || _a === void 0 ? void 0 : _a.findIndex((v) => v === value);
        if (i > -1) {
...
class PreRequests {
    constructor(requestTimeout = 2000, 
    // 10 seconds
    sweepInterval = 10000) {
        this.pendingPreRequests = new QueueMap();
    ...
    addPending(browserPreRequest) {
        ...
        if (pendingRequest) {
            ...
            if (!pendingRequest.timedOut) {
                ...
                (_a = pendingRequest.callback) === null || _a === void 0 ? void 0 : _a.call(pendingRequest, {
                    browserPreRequest: {
                        ...browserPreRequest,
                        ...timings,
                    },
            ...
            (_b = this.protocolManager) === null || _b === void 0 ? void 0 : _b.responseStreamTimedOut({
    ...
    removePendingPreRequest(requestId) {
    ...
    setPreRequestTimeout(requestTimeout) {
        this.requestTimeout = requestTimeout;
    }
