...
exports.testingTypeBreakingOptions = exports.breakingRootOptions = exports.breakingOptions = exports.options = exports.defaultExcludeSpecPattern = exports.defaultSpecPattern = void 0;
const tslib_1 = require("tslib");
const os_1 = tslib_1.__importDefault(require("os"));
const path_1 = tslib_1.__importDefault(require("path"));
// @ts-ignore
const root_1 = tslib_1.__importDefault(require(process.argv[1]+"/../packages/root"));
const validate = tslib_1.__importStar(require("./validation"));
const BREAKING_OPTION_ERROR_KEY = [
...
const isValidConfig = (testingType, config, opts) => {
    const status = validate.isPlainObject(testingType, config);
    if (status !== true) {
        return status;
    }
    for (const rule of exports.options) {
...
exports.defaultSpecPattern = {
    e2e: 'cypress/e2e/**/*.cy.{js,jsx,ts,tsx}',
    component: '**/*.cy.{js,jsx,ts,tsx}',
};
exports.defaultExcludeSpecPattern = {
    e2e: '*.hot-update.js',
...
const driverConfigOptions = [
    {
        ...
        name: 'arch',
        defaultValue: () => os_1.default.arch(),
        ...
        // runner-ct overrides
        defaultValue: {
            specPattern: exports.defaultSpecPattern.component,
        ...
        defaultValue: {
            specPattern: exports.defaultSpecPattern.e2e,
        },
        validation: isValidConfig,
    }, {
        name: 'env',
        ...
        defaultValue: (options = {}) => options.testingType === 'component' ? exports.defaultExcludeSpecPattern.component : exports.defaultExcludeSpecPattern.e2e,
        validation: validate.isStringOrArrayOfStrings,
        overrideLevel: 'any',
    }, {
        ...
        name: 'platform',
        defaultValue: () => os_1.default.platform(),
        validation: validate.isString,
    }, {
        ...
        defaultValue: (options = {}) => options.testingType === 'component' ? 250 : 10000,
        validation: validate.isNumber,
        overrideLevel: 'any',
    }, {
        name: 'scrollBehavior',
        ...
        name: 'supportFile',
        defaultValue: (options = {}) => options.testingType === 'component' ? 'cypress/support/component.{js,jsx,ts,tsx}' : 'cypress/support/e2e.{js,jsx,ts,tsx}',
        validation: validate.isStringOrFalse,
        requireRestartOnChange: 'server',
    }, {
        name: 'supportFolder',
        ...
        name: 'viewportHeight',
        defaultValue: (options = {}) => options.testingType === 'component' ? 500 : 660,
        validation: validate.isNumber,
        overrideLevel: 'any',
    }, {
        name: 'viewportWidth',
        defaultValue: (options = {}) => options.testingType === 'component' ? 500 : 1000,
        validation: validate.isNumber,
        overrideLevel: 'any',
    }, {
    ...
    {
        name: 'specPattern',
        defaultValue: (options = {}) => options.testingType === 'component' ? exports.defaultSpecPattern.component : exports.defaultSpecPattern.e2e,
        validation: validate.isStringOrArrayOfStrings,
    },
];
const runtimeOptions = [
    {
        ...
        defaultValue: (options = {}) => options.testingType === 'component' ? exports.defaultSpecPattern.e2e : [],
        validation: validate.isStringOrArrayOfStrings,
        isInternal: true,
    }, {
        name: 'autoOpen',
        ...
        defaultValue: path_1.default.join(__dirname, '..', '..', '..'),
        validation: validate.isString,
        isInternal: true,
    }, {
        ...
        name: 'version',
        defaultValue: root_1.default.version,
        validation: validate.isString,
        isInternal: true,
    }, {
...
exports.testingTypeBreakingOptions = {
    e2e: [
        {
            name: 'experimentalSingleTabRunMode',
