...
describe('header', () => {
    let runner;
    let runnables;
    function setupReporter(opts) {
        if (opts === null || opts === void 0 ? void 0 : opts.skipRunnableCreation) {
            runnables = {};
        }
        else {
        ...
        cy.get('.reporter').then(() => {
            runner.emit('runnables:ready', { ...runnables, testFilter: opts === null || opts === void 0 ? void 0 : opts.testFilter, totalUnfilteredTests: opts === null || opts === void 0 ? void 0 : opts.totalUnfilteredTests });
