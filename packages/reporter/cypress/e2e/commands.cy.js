...
describe('commands', { viewportHeight: 1000 }, () => {
    ...
    context('command group', () => {
        ...
        beforeEach(() => {
            ...
            groupId = (0, utils_1.addCommand)(runner, {
                id: fakeIdForTest,
                name: 'within',
                type: 'child',
            });
        ...
        context('clicking group', () => {
            ...
            it('displays with nested logs', () => {
                const nestedGroupId = (0, utils_1.addCommand)(runner, {
                    name: 'nested-within',
                    state: 'passed',
                    type: 'child',
                    group: groupId,
            ...
            describe('session group', () => {
                it('closed when nested logs that pass', () => {
                    ...
                    const nestedSessionGroupId = (0, utils_1.addCommand)(runner, {
                        name: 'session',
    ...
    context('test error', () => {
        ...
        it('renders recovered error for command', () => {
            cy.fixture('command_error').then((_commandErr) => {
                const groupId = (0, utils_1.addCommand)(runner, {
                    name: 'session',
        ...
        it('renders recovered error for nested group command', () => {
            cy.fixture('command_error').then((_commandErr) => {
                ...
                const nested = (0, utils_1.addCommand)(runner, {
                    type: 'system',
                    name: 'validate',
                    state: 'failed',
                    group: groupId,
