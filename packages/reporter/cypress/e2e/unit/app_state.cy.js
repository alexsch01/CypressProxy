...
const app_state_1 = tslib_1.__importStar(require("../../../src/lib/app-state"));
describe('app state', () => {
    it('exports singleton by default', () => {
        expect(app_state_1.default).to.be.instanceof(app_state_1.AppState);
    });
    context('#startRunning', () => {
        it('sets isRunning to true', () => {
            const instance = new app_state_1.AppState();
