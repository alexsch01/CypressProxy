...
describe('Err model', () => {
    ...
    context('#update', () => {
        let err;
        beforeEach(() => {
            err = new err_model_1.default({ name: 'BadError', message: 'Something went wrong' });
        });
