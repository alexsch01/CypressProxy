...
const compare = (filename, array) => {
    expect((0, util_1.getFilenameParts)(filename)).to.deep.equal(array);
};
describe('utils', () => {
    context('formatDuration', () => {
        it('formats no time', () => {
            expect((0, util_1.formatDuration)(0)).to.equal('--');
        });
        it('formats time of <1s', () => {
            expect((0, util_1.formatDuration)(1)).to.equal('1ms');
            expect((0, util_1.formatDuration)(999)).to.equal('999ms');
        });
        it('formats time of >=1s', () => {
            expect((0, util_1.formatDuration)(1000)).to.equal('00:01');
            expect((0, util_1.formatDuration)(1400)).to.equal('00:01');
            expect((0, util_1.formatDuration)(35620)).to.equal('00:36');
            expect((0, util_1.formatDuration)(59200)).to.equal('00:59');
        });
        it('formats time of >=1m', () => {
            expect((0, util_1.formatDuration)(60000)).to.equal('01:00');
            expect((0, util_1.formatDuration)(600000)).to.equal('10:00');
            expect((0, util_1.formatDuration)(3599000)).to.equal('59:59');
        });
        it('formats time of >=1h', () => {
            expect((0, util_1.formatDuration)(3600000)).to.equal('1:00:00');
            expect((0, util_1.formatDuration)(4200000)).to.equal('1:10:00');
            expect((0, util_1.formatDuration)(7199000)).to.equal('1:59:59');
        });
        it('displays larger times in hours', () => {
            expect((0, util_1.formatDuration)(360000000)).to.equal('100:00:00');
        });
    });
