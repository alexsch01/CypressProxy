...
const events_1 = tslib_1.__importDefault(require("../../../src/lib/events"));
const runnerStub = () => {
    return {
...
const appStateStub = () => {
    return {
        startRunning: sinon_1.default.spy(),
        pause: sinon_1.default.spy(),
        reset: sinon_1.default.spy(),
        resume: sinon_1.default.spy(),
        end: sinon_1.default.spy(),
        temporarilySetAutoScrolling: sinon_1.default.spy(),
        setStudioActive: sinon_1.default.spy(),
        stop: sinon_1.default.spy(),
    };
};
const runnablesStoreStub = () => {
    return {
        addLog: sinon_1.default.spy(),
        reset: sinon_1.default.spy(),
        runnableStarted: sinon_1.default.spy(),
        runnableFinished: sinon_1.default.spy(),
        setInitialScrollTop: sinon_1.default.stub(),
        setRunnables: sinon_1.default.spy(),
        testById: sinon_1.default.stub(),
        updateLog: sinon_1.default.spy(),
        removeLog: sinon_1.default.spy(),
    };
};
const scrollerStub = () => {
    return {
        getScrollTop: sinon_1.default.stub(),
    };
};
const statsStoreStub = () => {
    return {
        incrementCount: sinon_1.default.spy(),
        pause: sinon_1.default.spy(),
        reset: sinon_1.default.spy(),
        resume: sinon_1.default.spy(),
        start: sinon_1.default.spy(),
        startRunning: sinon_1.default.spy(),
        end: sinon_1.default.spy(),
    };
};
describe('events', () => {
    ...
    let runner;
    beforeEach(() => {
        events_1.default.__off();
        appState = appStateStub();
        runnablesStore = runnablesStoreStub();
        scroller = scrollerStub();
        statsStore = statsStoreStub();
        events_1.default.init({ appState, runnablesStore, scroller, statsStore });
        runner = runnerStub();
        events_1.default.listen(runner);
    });
    context('from runner', () => {
    ...
    context('from local bus', () => {
        ...
        it('emits runner:console:error with error on show:error', () => {
            ...
            events_1.default.emit('show:error', errorDetails);
        ...
        it('emits runner:console:error with error, test id and command id on show:error ', () => {
            ...
            events_1.default.emit('show:error', test);
            expect(runner.emit).to.have.been.calledWith('runner:console:error', {
                err: test.err,
                testId: 'test',
        ...
        it('emits runner:unpin:snapshot on unpin:snapshot', () => {
            events_1.default.emit('unpin:snapshot', 'command id');
        ...
        it('emits studio:init:test with test id on studio:init:test', () => {
            events_1.default.emit('studio:init:test', 'test id');
        ...
        it('emits studio:init:suite with test id on studio:init:suite', () => {
            events_1.default.emit('studio:init:suite', 'suite id');
