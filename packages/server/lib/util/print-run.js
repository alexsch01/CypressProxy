...
exports.beginUploadActivityOutput = exports.printCompletedArtifactUpload = exports.printPendingArtifactUpload = exports.printVideoPath = exports.printVideoHeader = exports.displayVideoCompressionProgress = exports.displayResults = exports.renderSummaryTable = exports.maybeLogCloudRecommendationMessage = exports.displaySpecHeader = exports.displayRunStarting = exports.gray = exports.cloudRecommendationMessage = void 0;
...
function displayVideoCompressionProgress(opts) {
    console.log('');
    const table = terminal_1.default.table({
        colWidths: [3, 21, 76],
...
exports.displayVideoCompressionProgress = displayVideoCompressionProgress;
const printVideoHeader = () => {
    console.log('');
    terminal_1.default.header('Video', {
        color: ['cyan'],
    });
};
exports.printVideoHeader = printVideoHeader;
const printVideoPath = (videoName) => {
...
exports.printVideoPath = printVideoPath;
const formatFileSize = (bytes) => {
    // in test environments, mask the value as it may differ from environment
    // to environment
    if (env_1.default.get('CYPRESS_INTERNAL_ENV') === 'test') {
        return (0, pretty_bytes_1.default)(1000);
    }
    return (0, pretty_bytes_1.default)(bytes);
};
const printPendingArtifactUpload = (artifact, labels) => {
...
exports.printPendingArtifactUpload = printPendingArtifactUpload;
const printCompletedArtifactUpload = (artifactUploadResult, labels, num) => {
    ...
    if (uploadDuration) {
        const durationOut = human_time_1.default.short(uploadDuration, 2);
...
exports.printCompletedArtifactUpload = printCompletedArtifactUpload;
const UPLOAD_ACTIVITY_INTERVAL = typeof env_1.default.get('CYPRESS_UPLOAD_ACTIVITY_INTERVAL') === 'undefined' ? 15000 : env_1.default.get('CYPRESS_UPLOAD_ACTIVITY_INTERVAL');
const beginUploadActivityOutput = () => {
    console.log('');
    process.stdout.write(chalk_1.default.bold.blue('  Uploading Cloud Artifacts: '));
    process.stdout.write(chalk_1.default.bold.blue('. '));
...
exports.beginUploadActivityOutput = beginUploadActivityOutput;
