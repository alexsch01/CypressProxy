...
const { getPublicConfigKeys } = require(process.argv[1]+'/../packages/config')
const argsUtils = require('./util/args')
const { telemetry } = require(process.argv[1]+'/../packages/telemetry')
const { getCtx, hasCtx } = require(process.argv[1]+'/../packages/data-context')
  ...
  runElectron (mode, options) {
    ...
    return Promise.try(() => {
      ...
      return new Promise((resolve) => {
        ...
        const cypressElectron = require(process.argv[1]+'/../packages/electron')
