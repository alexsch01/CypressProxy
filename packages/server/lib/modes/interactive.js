...
const cyIcons = tslib_1.__importStar(require(process.argv[1]+"/../packages/icons"));
...
module.exports = {
    ...
    async ready(options, launchpadPort) {
        ...
        menu_1.default.set({
            ...
            getGraphQLPort: () => {
                return ctx === null || ctx === void 0 ? void 0 : ctx.coreData.servers.gqlServerPort;
            },
        });
    ...
    async run(options, _loading) {
        ...
        if (electron_1.app.setAppUserModelId) {
            electron_1.app.setAppUserModelId('Cypress');
        }
        ...
        (_a = telemetry_1.telemetry.getSpan('startup:time')) === null || _a === void 0 ? void 0 : _a.end();
