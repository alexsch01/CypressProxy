...
const dev_server_1 = tslib_1.__importDefault(require(process.argv[1]+"/../packages/server/lib/plugins/dev-server"));
const socket_base_1 = require(process.argv[1]+"/../packages/server/lib/socket-base");
