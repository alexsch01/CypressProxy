...
const util_1 = require(process.argv[1]+"/../packages/data-context/src/util");
...
class OpenProject {
    ...
    async launch(browser, spec, prevOptions) {
        ...
        this.relaunchBrowser = async () => {
            ...
            if (process.env.CYPRESS_INTERNAL_E2E_TESTING_SELF) {
                return await browsers_1.default.connectToExisting(browser, options, automation, (_a = this._ctx) === null || _a === void 0 ? void 0 : _a.coreData.servers.cdpSocketServer);
            }
            ...
            if (options.shouldLaunchNewTab && browser.name !== 'electron') {
                ...
                return await browsers_1.default.connectToNewSpec(browser, { onInitializeNewBrowserTab, ...options }, automation, (_b = this._ctx) === null || _b === void 0 ? void 0 : _b.coreData.servers.cdpSocketServer);
            }
    ...
    async resetBrowserTabsForNextTest(shouldKeepTabOpen) {
        var _a;
        try {
            await ((_a = this.projectBase) === null || _a === void 0 ? void 0 : _a.resetBrowserTabsForNextTest(shouldKeepTabOpen));
        }
        catch (e) {
    ...
    async connectProtocolToBrowser(options) {
        await browsers_1.default.connectProtocolToBrowser(options);
    }
    ...
    updateTelemetryContext(context) {
        var _a;
        return (_a = this.projectBase) === null || _a === void 0 ? void 0 : _a.server.socket.updateTelemetryContext(context);
    }
